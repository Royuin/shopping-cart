...
function ProductDetailsLayout({ addToCart, productsArray, incrementQuantity }) {
    ...
    if (quantityError === true) {
      return (
        <p className='quantity-error'>
          <em>Quantity must be greater than 0 and no greater than 100.</em>
        </p>
      );
    }
  }
  ...
  useEffect(() => {
    if (quantity >= 1 && quantity <= 100) setQuantityError(false);
  }, [quantity]);
    ...
    <>
      <main className='details-main'>
        ...
        <div className='details-right'>
          <h2>{id}</h2>
          <h4>
            Tasting Notes: <span>Buzzword, Buzzword, Buzzword</span>
          </h4>
          ...
          <div className='steeping-wrap'>
            ...
            <p>
              Heat water to 180{'\u00b0'} use 8 oz water for one teaspoon. Let
              it steep for 3-5 minutes and enjoy!
            </p>
          </div>
          <br />
          ...
          <label htmlFor='quantity' className='quantity-label'>
            ...
            <div className='quantity-wrapper'>
              <button
                ...
                onClick={() => decrementQuantity(product.id, quantity)}
              >
                -
              </button>
              <input
          ...
          <p>
            <em>Approximately 40 servings</em>
          </p>
          <button
